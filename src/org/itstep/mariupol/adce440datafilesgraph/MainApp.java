...
public class MainApp extends Application {
    ...
    //TODO^ добавить в представление кнопку, по клику на которой будет применяться фильтр:
    //https://github.com/berndporr/iirj
    //с настройками: тип - Чебышева, частота процесса 1500, порядок - 2, частота отсечения - 125
